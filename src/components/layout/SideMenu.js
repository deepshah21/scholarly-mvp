    ...
    getMenu() {
        ...
        return (
            <Menu fixed='left' borderless className={(this.props.smallMenu ? 'small-side' : '') + ' side'} inverted pointing vertical>
                ...
                <Menu.Item as={Link} to={'/departments'} name='departments'
                           active={activeItem === 'departments'}
                           onClick={this.handleItemClick}>
                    <TextIcon hideText={this.props.smallMenu} name='globe'>
                        Departments
                    </TextIcon>
                </Menu.Item>
                ...
                <Menu.Item as={Link} to={'/students'} name='students'
                           active={activeItem === 'students'}
                           onClick={this.handleItemClick}>
                    <TextIcon hideText={this.props.smallMenu} name='student'>
                        Students
                    </TextIcon>
                </Menu.Item>

                <Menu.Item as={Link} to={'/fees'} name='fees'
                           active={activeItem === 'fees'}
                           onClick={this.handleItemClick}>
                    <TextIcon hideText={this.props.smallMenu} name='credit card'>
                        Fees
                    </TextIcon>
                </Menu.Item>
